      ...
      child: Center(
        child: AnimatedContainer(
          ...
          child: AnimatedSize(
            ...
            child: Row(mainAxisSize: .min, children: _buildCarousel(sequence)),
          ),
        ),
      ),
    );
